...
#One agent uses Fully Kelly, and the other one behaves according to Prospect Theorey (i.e., it 
#becomes 'risk averse' when it is winning by betting only a fraction of Kelly, in this case 0.5, and
#risk seaking when it is losing, or betting 1.5 the fraction given by the Kelly Criterion)
...
for (i in 1:100){#100 games to play
  ...
  }else if (SaveWealth[i,2]>SaveWealth[i,1]){
