#Console Input
#Experiment 1
#HUTable and HUbettinground R functions are edited so that both agents use full kelly and carry out a total
#of 10 simulations to arrive at their expected probability of winning 
...
#Carry Out the experiment with both agents running on full Kelly and carrying out the same number of MCS to approximate probability of winning. 
#This should lead to both winning roughly 50% of the time as there is no
#systematic advantage of one over the other, other than the occasional lucky streak
